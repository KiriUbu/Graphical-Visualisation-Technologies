var app = ( function() {
    ...
    var camera = {
        ...
        zAngle : 0,
        //Angle to X-Axis for camera when orbiting the center given in radian
        xAngle : 0,
    ...
    function initPipeline() {
        gl.clearColor(198/255, 226/255, 255/255, 1);
        ...
        window.onkeydown = function(evt) {
            ...
            switch(c) {
                ...
                case('&'): // Pfeiltaste oben
                    // lookAt bleibt gleich, Position erh�hen
                ...
                case('1'):
                    document.getElementById('recursionLevel').innerHTML = (parseInt(c)-1).toString();
                    models = [];
                    initModels();
                    break;
                case('2'):
    ...
    function render() {
        ...
        //mat4.rotate(camera.vMatrix, camera.vMatrix, camera.zAngle, [1,0,0]);
    ...
    function draw(model) {
        ...
        //Bind vertex buffer to attribute variable
        var colAttrib = gl.getAttribLocation(prog, 'aColor');
        ...
        if(wireframe) {
            ...
            //gl.vertexAttrib3f(prog.colAttrib, -1, -1, -1);
